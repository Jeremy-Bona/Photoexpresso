 ...
 */
class Useractions extends \PhotoexpressoBundle\Entity\Useractions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Useractions' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Useractions' . "\0" . 'datetime', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Useractions' . "\0" . 'details', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Useractions' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Useractions $proxy) {
