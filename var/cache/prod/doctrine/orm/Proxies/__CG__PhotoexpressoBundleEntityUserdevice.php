 ...
 */
class Userdevice extends \PhotoexpressoBundle\Entity\Userdevice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'name', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'datetime', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'connected', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'device', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Userdevice' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Userdevice $proxy) {
