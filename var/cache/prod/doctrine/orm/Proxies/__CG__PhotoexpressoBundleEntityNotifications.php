 ...
 */
class Notifications extends \PhotoexpressoBundle\Entity\Notifications implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Notifications' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Notifications' . "\0" . 'datetime', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Notifications' . "\0" . 'message', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Notifications' . "\0" . 'checked', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Notifications' . "\0" . 'user'];
        }
