 ...
 */
class Photo extends \PhotoexpressoBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Photo' . "\0" . 'path', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Photo' . "\0" . 'basename', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Photo' . "\0" . 'actions'];
        }
