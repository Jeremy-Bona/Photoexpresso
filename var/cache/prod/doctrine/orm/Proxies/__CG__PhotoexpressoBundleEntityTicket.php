 ...
 */
class Ticket extends \PhotoexpressoBundle\Entity\Ticket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Ticket' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Ticket' . "\0" . 'datetime', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Ticket' . "\0" . 'subject', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Ticket' . "\0" . 'message', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Ticket' . "\0" . 'user'];
        }
