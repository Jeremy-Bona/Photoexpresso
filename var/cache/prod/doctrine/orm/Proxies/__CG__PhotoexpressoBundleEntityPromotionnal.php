 ...
 */
class Promotionnal extends \PhotoexpressoBundle\Entity\Promotionnal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Promotionnal' . "\0" . 'idpromotionnal', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Promotionnal' . "\0" . 'datecreate', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Promotionnal' . "\0" . 'datestart', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Promotionnal' . "\0" . 'datestop', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Promotionnal' . "\0" . 'url'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Promotionnal $proxy) {
    ...
    public function getIdpromotionnal()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdpromotionnal();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdpromotionnal', []);

        return parent::getIdpromotionnal();
    }
