 ...
 */
class Actions extends \PhotoexpressoBundle\Entity\Actions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Actions' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Actions' . "\0" . 'datetime', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Actions' . "\0" . 'details', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Actions' . "\0" . 'user', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Actions' . "\0" . 'photo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Actions $proxy) {
