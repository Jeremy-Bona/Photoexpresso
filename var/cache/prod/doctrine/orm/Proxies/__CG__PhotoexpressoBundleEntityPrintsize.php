 ...
 */
class Printsize extends \PhotoexpressoBundle\Entity\Printsize implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Printsize' . "\0" . 'id', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Printsize' . "\0" . 'width', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Printsize' . "\0" . 'height', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Printsize' . "\0" . 'ratio', '' . "\0" . 'PhotoexpressoBundle\\Entity\\Printsize' . "\0" . 'available'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Printsize $proxy) {
