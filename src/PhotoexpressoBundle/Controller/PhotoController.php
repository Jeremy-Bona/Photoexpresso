...
use PhotoexpressoBundle\Entity\Photo;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $photos = $em->getRepository('PhotoexpressoBundle:Photo')->findAll();
    ...
    {
        $photo = new Photo();
        $form = $this->createForm('PhotoexpressoBundle\Form\PhotoType', $photo);
    ...
    {
        $deleteForm = $this->createDeleteForm($photo);
        $editForm = $this->createForm('PhotoexpressoBundle\Form\PhotoType', $photo);
