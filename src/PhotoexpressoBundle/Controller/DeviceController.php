...
use PhotoexpressoBundle\Entity\Device;
...
class DeviceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $devices = $em->getRepository('PhotoexpressoBundle:Device')->findAll();
    ...
    {
        $device = new Device();
        $form = $this->createForm('PhotoexpressoBundle\Form\DeviceType', $device);
    ...
    {
        $deleteForm = $this->createDeleteForm($device);
        $editForm = $this->createForm('PhotoexpressoBundle\Form\DeviceType', $device);
